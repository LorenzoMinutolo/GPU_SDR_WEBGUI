...
from models import filename_to_abs_path
...
class Analysis_Config(object):
    ...
    def convert_filenames(self):
        ...
        for f in self.file_list:
            self.path_list.append(filename_to_abs_path(f))
    ...
    def analysis_check_single_file(self, path):
        '''
        ...
        # Noise type
            ...
            if u.check_resonator_group(path):
                self.check_if_previously_excluded(filename)
        ...
        # TODO add raw files
            ...
            if not self.check_if_already_included(filename):
                ...
                self.config['exclusion_paths'].append(dir_name)
    ...
    def check_file_list(self):
        ...
        for i in range(len(self.path_list)):
            self.analysis_check_single_file(self.path_list[i])
